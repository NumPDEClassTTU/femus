...
void show_usage()
{
  ...
  std::cout << "e.g.: ./fsisteady --inputfile ./input/input_turek.json" << std::endl;
  std::cout << "e.g.: ./fsisteady --inputfile ./input/input_beam.json" << std::endl;
  std::cout << "e.g.: ./fsisteady --inputfile ./input/input_drum.json" << std::endl;
  std::cout << "e.g.: ./fsisteady --inputfile ./input/input_bathe_FSI.json" << std::endl;
  std::cout << "e.g.: ./fsisteady --inputfile ./input/input_bathe_shell.json" << std::endl;
  std::cout << "e.g.: ./fsisteady --inputfile ./input/input_bathe_cylinder.json" << std::endl;
  std::cout << "e.g.: ./fsisteady --inputfile ./input/input_comsolbenchmark.json" << std::endl;
}
